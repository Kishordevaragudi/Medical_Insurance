...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->artifact_entity.ModelEvaluationArtifact:
        try:
            ...
            log.info("finding the location of previous model")
            ...
            log.info("comparision between new model and old model")
            previous_model_score = r2_score(y_true=y_ture, y_pred=y_pred)


            # Accuracy current model
            log.info("Accuracy current model")
            ...
            log.info("final comparision between both the model")
