...
#from sklearn.combine import SMOTE (If data has imbalance we use this)
...
class DataTransformation:
    def __init__(self,data_transformation_config:config_entity.DataTransformationConfig,
        ...
        try:
            log.info(f"*********Data Transformation************")
    ...
    def get_data_transform_object(cls)->Pipeline:
        try:
            log.info(f"applying simple_imputer to handling missing values")
            simple_imputer = SimpleImputer(strategy ='constant',fill_value = 0)
            
            log.info(f"Handling the outliers")
    ...
    def initaite_data_transformation(self)->artifact_entity.DataTransformationArtifact:
        try:
            ...
            log.info(f"dividing the dataset into dependent and Independent feature")
            ...
            log.info(f"converting categorical into numerical data")
            ...
            log.info(f"Creating converted data into transformation")
